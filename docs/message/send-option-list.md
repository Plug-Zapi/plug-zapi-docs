...
`POST` https://api.plugzapi.com.br/instances/SUA_INSTANCIA/token/SEU_TOKEN/send-option-list
...
```json
{
  ...
  "optionList": {
    ...
    "options": [
      {
        "id": "1",
        "description": "PlugZapi Mais software, menos esforço",
        "title": "PlugZapi"
      },
      {
        "id": "2",
...
<iframe src="//api.apiembed.com/?source=https://raw.githubusercontent.com/Plug-Zapi/plug-zapi-docs/master/json-examples/send-option-list.json&targets=all" frameborder="0" scrolling="no" width="100%" height="500px" seamless></iframe>
